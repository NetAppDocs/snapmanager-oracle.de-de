...
summary: Die Beispielskripte sind im Verzeichnis Plugins/examples/noasmlib des Installationsverzeichnisses für SnapManager für Oracle verfügbar. 
---
...
[role="lead"]
Die Beispielskripte sind im Verzeichnis Plugins/examples/noasmlib des Installationsverzeichnisses für SnapManager für Oracle verfügbar.
